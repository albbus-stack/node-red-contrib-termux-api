module.exports = function (RED) {
  ...
  function Cellinfo(n) {
    ...
    node.on("input", function (msg) {
      termux
        .exec("termux-telephony-cellinfo")
        .then(function (data) {
          msg.payload = data;
          node.send(msg);
        })
  ...
  function Devinfo(n) {
    ...
    node.on("input", function (msg) {
      termux
        .exec("termux-telephony-deviceinfo")
        .then(function (data) {
          msg.payload = data;
          node.send(msg);
        })
  ...
  function ClipboardSet(n) {
    ...
    node.on("input", function (msg) {
      termux
        .exec("termux-clipboard-set", [msg.payload], termux.VOID)
        .then(function () {
          node.send(msg);
        })
        .catch(function (err) {
  ...
  function Dialog(n) {
    ...
    node.on("input", function (msg) {
      ...
      termux
        .exec("termux-dialog", opts, termux.STR)
        .then(function (data) {
          msg.payload = data;
          node.send(msg);
        })
  ...
  function Download(n) {
    ...
    node.on("input", function (msg) {
      ...
      termux
        .exec("termux-download", opts, termux.VOID)
        .then(function () {
          node.send(msg);
        })
        .catch(function (err) {
  ...
  function TTSSpeak(n) {
    ...
    node.on("input", function (msg) {
      ...
      termux
        .exec("termux-tts-speak", opts, termux.VOID)
        .then(function () {
          node.send(msg);
        })
        .catch(function (err) {
  ...
  function Vibrate(n) {
    ...
    node.on("input", function (msg) {
      ...
      termux
        .exec("termux-vibrate", opts, termux.VOID)
        .then(function () {
          node.send(msg);
        })
        .catch(function (err) {
  ...
  function Toast(n) {
    ...
    node.on("input", function (msg) {
      ...
      termux
        .exec("termux-toast", opts, termux.VOID)
        .then(function () {
          node.send(msg);
        })
        .catch(function (err) {
  ...
  function SMSSend(n) {
    ...
    node.on("input", function (msg) {
      ...
      termux
        .exec("termux-sms-send", opts, termux.VOID)
        .then(function () {
          node.send(msg);
        })
        .catch(function (err) {
  ...
  function Share(n) {
    ...
    node.on("input", function (msg) {
      ...
      termux
        .exec("termux-share", opts, termux.VOID)
        .then(function () {
          node.send(msg);
        })
        .catch(function (err) {
  ...
  function Notification(n) {
    try {
      ...
      node.on("input", function (msg) {
        ...
        const nodeTermuxCall =
          "node ~/.node-red/node_modules/node-red-contrib-termux-api/red_termux.js";
        ...
        termux
          .exec("termux-notification", opts, termux.VOID)
          .catch(function (err) {
            node.error(err);
          });
      });
